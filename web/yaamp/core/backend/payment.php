...
function BackendCoinPayments($coin)
{
    ...
    //Changed from Pool4U
    if ($coin->symbol == 'AXE' || $coin->symbol == 'BZX' || $coin->symbol == 'ZOC' || $coin->symbol == 'PGN' || $coin->symbol == 'SCRIV' || $coin->symbol == 'GENIX' || $coin->symbol == 'SOV' || $coin->symbol == 'GOLD' || $coin->symbol == 'SNARK' || $coin->symbol == 'SIN' || $coin->symbol == 'PRCX' || !empty($coin->payout_max))
    {
